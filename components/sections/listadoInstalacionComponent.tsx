                  ...
                  <Table className="min-w-full">
                    <TableHeader>
                      <TableRow>
                        ...
                        <TableHead className="w-32 min-w-[150px] hidden sm:table-cell">
                          Ubicación
                        </TableHead>
                        <TableHead className="w-24 min-w-[100px] hidden md:table-cell">
                          Recursos
                        </TableHead>
                              ...
                              <Button
                                ...
                                onClick={async () => {
                                  ...
                                  if (
                                    ...
                                    try {
                                      console.log(
                                        "Cargando datos completos para los baños:",
                                        servicio.banosInstalados,
                                      );
                                      console.log(
                                        "Tipo de servicio:",
                                      ...
                                      const containsOnlyNumbers =
                                        servicio.banosInstalados.every(
                                          (bano: any) =>
                                            typeof bano === "number",
                                        );
                                      ...
                                      if (
                                        ...
                                        if (Array.isArray(sanitariosResponse)) {
                                          ...
                                          allSanitarios =
                                            sanitariosResponse.items;
                                        } else if (sanitariosResponse?.data) {
                                          allSanitarios =
                                            sanitariosResponse.data;
                                        }

                                        console.log(
                                          "Todos los sanitarios obtenidos:",
                                          allSanitarios,
                                        );
                                        console.log(
                                          "Primer sanitario estructura:",
                                          allSanitarios[0],
                                        );
                                        console.log(
                                          "Total sanitarios encontrados:",
                                          allSanitarios.length,
                                        );
                                        console.log(
                                          "ContainsOnlyStrings:",
                                          containsOnlyStrings,
                                          ...
                                          allSanitarios.filter(
                                            (sanitario: any) => {
                                              ...
                                              const sanitarioId =
                                                ...
                                                sanitario.id ||
                                                sanitario.banoId;
                                              const sanitarioCodigoInterno =
                                                sanitario.codigo_interno;

                                              console.log(
                                                `Procesando sanitario: ID=${sanitarioId}, codigo_interno="${sanitarioCodigoInterno}", modelo="${sanitario.modelo}"`,
                                              );

                                              // Verificar si coincide con algún elemento en banosInstalados
                                              const isMatch =
                                                servicio.banosInstalados.some(
                                                  (banoItem: any) => {
                                                    console.log(
                                                      `  Comparando banoItem="${banoItem}" (tipo: ${typeof banoItem})`,
                                                    );
                                                    ...
                                                    if (
                                                      ...
                                                      console.log(
                                                        `    Comparación por código interno: "${banoItem}" === "${sanitarioCodigoInterno}" = ${matchPorCodigo}`,
                                                      );
                                                      console.log(
                                                        `    Comparación por ID: "${banoItem}" === "${sanitarioId}" = ${matchPorId}`,
                                                      );
                                                      console.log(
                                                        `    Match final: ${match}`,
                                                      );
                                                      ...
                                                      const match =
                                                        ...
                                                        String(sanitarioId);
                                                      console.log(
                                                        `    Comparación por ID: "${banoItem}" === "${sanitarioId}" = ${match}`,
                                                      );
                                                      return match;
                                                    }
                                                  },
                                              ...
                                              console.log(
                                                `  Resultado final para sanitario ${sanitarioId}: ${isMatch}`,
                                              );
                                              return isMatch;
                                            },
                                          );
                                      ...
                                      console.error(
                                        "Error al cargar datos de baños:",
                                        error,
                                      );
                                      setBanosCompletos([]);
                                    }
                        ...
                        */}
                        {banosCompletos && banosCompletos.length > 0
                          ...
                          : // Fallback: mostrar baños instalados básicos para servicios de limpieza
                            ...
                            selectedServicio.banosInstalados.map(
                              (banoCodigoInterno: any, index: number) => {
                                // Log para debugging - ver qué estructura tienen los datos
                                console.log(
                                  "Código interno del baño instalado (fallback):",
                                  banoCodigoInterno,
                                );
                                ...
                                if (typeof banoCodigoInterno === "string") {
                                  ...
                                  const banoCompleto = banosCompletos.find(
                                    (bano: any) =>
                                      String(bano.codigo_interno) ===
                                      String(banoCodigoInterno),
                                  );

                                  const modelo =
                                    banoCompleto?.modelo || "No especificado";
                                ...
                                const codigoInterno =
                                  banoCodigoInterno.codigo_interno ||
